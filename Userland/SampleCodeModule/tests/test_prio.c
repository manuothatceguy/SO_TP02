...
#define MINOR_WAIT 10000000000 // TODO: Change this value to prevent a process from flooding the screen
#define WAIT 10000000000000      // TODO: Change this value to make the wait long enough to see theese processes beeing run at least twice
...
uint64_t test_prio() {
  ...
  for (i = 0; i < TOTAL_PROCESSES; i++)
    pids[i] = syscall_create_process("endless_loop_print", (fnptr)endless_loop_print, argv, prio[i], 0, -1, 1);
